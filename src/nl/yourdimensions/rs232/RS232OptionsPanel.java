...
final class RS232OptionsPanel extends javax.swing.JPanel {
    ...
    RS232OptionsPanel(final RS232OptionsPanelController controller) {
       ...
       jLogFileTextField.getDocument().addDocumentListener(listener);
    ...
    private void initComponents() {
        ...
        jEnableLoggingCheckBox = new javax.swing.JCheckBox();
        jLabel1 = new javax.swing.JLabel();
        jLogFileTextField = new javax.swing.JTextField();
        jBrowseLogFileButton = new javax.swing.JButton();
        jDefaultLogFileButton = new javax.swing.JButton();
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jEnableLoggingCheckBox, org.openide.util.NbBundle.getMessage(RS232OptionsPanel.class, "RS232OptionsPanel.jEnableLoggingCheckBox.text")); // NOI18N
        jEnableLoggingCheckBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jEnableLoggingCheckBoxActionPerformed(evt);
            }
        });
        ...
        jLogFileTextField.setText(org.openide.util.NbBundle.getMessage(RS232OptionsPanel.class, "RS232OptionsPanel.jLogFileTextField.text")); // NOI18N
        jLogFileTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jLogFileTextFieldActionPerformed(evt);
            }
        });

        org.openide.awt.Mnemonics.setLocalizedText(jBrowseLogFileButton, org.openide.util.NbBundle.getMessage(RS232OptionsPanel.class, "RS232OptionsPanel.jBrowseLogFileButton.text")); // NOI18N
        jBrowseLogFileButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBrowseLogFileButtonActionPerformed(evt);
            }
        });

        org.openide.awt.Mnemonics.setLocalizedText(jDefaultLogFileButton, org.openide.util.NbBundle.getMessage(RS232OptionsPanel.class, "RS232OptionsPanel.jDefaultLogFileButton.text")); // NOI18N
        jDefaultLogFileButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jDefaultLogFileButtonActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jEnableLoggingCheckBox)
                        .addContainerGap())
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLogFileTextField)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jBrowseLogFileButton)
                        .addGap(6, 6, 6)
                        .addComponent(jDefaultLogFileButton))))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(jLogFileTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jBrowseLogFileButton)
                    .addComponent(jDefaultLogFileButton)))
        );
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(jDataBits, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        ...
        jBautRateBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "300", "1200", "2400", "4800", "9600", "14400", "19200", "28800", "38400", "57600", "115200", "230400", "460800", "576000", "921600" }));
        jBautRateBox.setSelectedIndex(10);
        jBautRateBox.setPrototypeDisplayValue("000000");
    ...
    private void jDefaultLogFileButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jDefaultLogFileButtonActionPerformed
        jLogFileTextField.setText(System.getProperty("user.home") +  System.getProperty("file.separator")  +"log.txt");
        controller.changed();
    }//GEN-LAST:event_jDefaultLogFileButtonActionPerformed

    private void jBrowseLogFileButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBrowseLogFileButtonActionPerformed
        JFileChooser fc = new JFileChooser();
        fc.setFileSelectionMode(JFileChooser.FILES_ONLY);
        fc.setCurrentDirectory(new File(System.getProperty("user.home")));
        fc.setDialogType(JFileChooser.CUSTOM_DIALOG);
        fc.setSelectedFile(new File(jLogFileTextField.getText()));
        int returnVal = fc.showOpenDialog(WindowManager.getDefault().getMainWindow());
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            File file = fc.getSelectedFile();
            jLogFileTextField.setText(file.getPath());
        }
        controller.changed();
    }//GEN-LAST:event_jBrowseLogFileButtonActionPerformed

    private void jEnableLoggingCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jEnableLoggingCheckBoxActionPerformed
        controller.changed();
    }//GEN-LAST:event_jEnableLoggingCheckBoxActionPerformed

    private void jLogFileTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jLogFileTextFieldActionPerformed
        controller.changed();
    }//GEN-LAST:event_jLogFileTextFieldActionPerformed
    ...
    void load() {
        jLogFileTextField.setText("" + UISettings.getInstance().getLogPath());
        jEnableLoggingCheckBox.setSelected(UISettings.getInstance().isLogging());
    ...
    void store() {
        ...
        RS232.getInstance().setLogging(jEnableLoggingCheckBox.isSelected());
        UISettings.getInstance().setLogging(jEnableLoggingCheckBox.isSelected());
        UISettings.getInstance().setLogPath(jLogFileTextField.getText());
    ...
    boolean valid() {
        ...
        if (jEnableLoggingCheckBox.isSelected() && jLogFileTextField.getText().equals("")) {
            return false;
        }
        return true;
    }
    ...
    private javax.swing.JButton jBrowseLogFileButton;
    private javax.swing.JComboBox jDataBits;
    private javax.swing.JButton jDefaultLogFileButton;
    private javax.swing.JCheckBox jEnableLoggingCheckBox;
    ...
    private javax.swing.JTextField jLogFileTextField;
